...
§
Configured model aliases: MimoM, QwenM, ClaudeM, geminiM, opencodeM — all on openai-api provider (9router). User's openai-api provider (9router) had API key rejected (HTTP 401) as of Aug 2026.